...
# Source0-md5:	c8b4012ba793bf2c7d922fee3a5e28bd
...
BuildRequires:	libva-drm-devel >= 1.4.0
BuildRequires:	libva-wayland-devel >= 1.4.0
BuildRequires:	libva-x11-devel >= 1.4.0
