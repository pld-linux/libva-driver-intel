...
# Source0-md5:	16752f1584398265072129553b7907ce
...
BuildRequires:	libva-drm-devel >= 1.5.0
BuildRequires:	libva-wayland-devel >= 1.5.0
BuildRequires:	libva-x11-devel >= 1.5.0
